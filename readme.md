...
Возможности:
	...
	Временно убраны связанные опции (в дальнейшем будут возвращены)
...
1С:Предприятие:
    ...
    Управление торговлей 10.3.29.1, 11.1.6.26, 11.1.10.138
...
ВНИМАНИЕ для тех кто обновляет модуль, 
1. Удаляем модификатор
2. Обновляем модификаторы
3. Устанавливаем расширение
4. Обновляем модификаторы
